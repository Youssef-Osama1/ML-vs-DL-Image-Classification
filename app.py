...
@st.cache_resource
def load_model_from_hf(compile=False):
    path = hf_hub_download(repo_id="itsYoussefAI/teeth-model", filename="best_resnet.keras")
...
if uploaded:
    ...
    with col2:
        with st.spinner("Analyzing..."):
            try:
                model = load_model_from_hf(compile=False)
